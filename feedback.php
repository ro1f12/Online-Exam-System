...
<div class="col-md-10">
<a href="mailto:helpdesk@oes.com" style="color:#000000">helpdesk@oes.com</a><br /><br />
...
<a href="https://gauhati.ac.in" target="_blank">About us</a>
</div>
<div class="col-md-3 box">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="row">
		<div class="col-md-4">
		 <img src="image/dev.jpg" width=100 height=100 alt="John Doe" class="img-rounded">
		 </div>
		 <div class="col-md-5">
		<a href="#" style="color:#202020; font-family:'typo' ; font-size:18px" title="Find on Facebook">John Doe</a>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">+910000000000</h4>
		<h4 style="font-family:'typo' ">dev@oes.com</h4>
		<h4 style="font-family:'typo' ">Gauhati University</h4></div></div>
		</p>
      </div>
